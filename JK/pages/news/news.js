...
Page({
  ...
  data: {
    ...
    fun:"娱乐",
    sport:"体育",
    image1:"/images/lb/news_lb_1.png",
    image2: "/images/lb/news_lb_2.png",
    image3: "/images/lb/news_lb_3.png",
    image4: "/images/lb/news_lb_4.png",
    showBackTop:false
  },
  /**
   * 页面跳转
  ...
  onTapToDetail1:function(options){
    ...
    wx.navigateTo({
      url: '../news-detail1/news-detail1?id='+newsId,
    })
  },
  /**
   * 生命周期函数--监听页面加载
