...
Page({
  ...
  data: {
    ...
    fun: "娱乐",
    sport: "体育",
    image1: "/images/lb/dis_lb_1.png",
    image2: "/images/lb/dis_lb_2.png",
    image3: "/images/lb/dis_lb_3.png",
    image4: "/images/lb/dis_lb_4.png",
    showBackTop: false
  },
  /**
   * 跳转函数
  ...
  onTapToDetail1: function (options) {
    ...
    wx.navigateTo({
      url: '../../news-detail3/news-detail3?id=' + newsId,
    })
  },
  /**
   * 生命周期函数--监听页面加载
